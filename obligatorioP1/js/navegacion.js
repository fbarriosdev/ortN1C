...
cambiarSeccion("seccionVender");

function mostrarSeccion() {
  let idBtn = this.getAttribute("id"); //"btnSeccionBienvenida"
  let idSeccion = "s" + idBtn.substring(4); //"seccionBienvenida"
  cambiarSeccion(idSeccion);
}

function cambiarSeccion(idS) {
  //idS = "seccionBienvenida"
  ocultarSecciones();
